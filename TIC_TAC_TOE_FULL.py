...
#Welcome message
    ...
    while True:
        ...
        while True:
            ...
            # making the loop for the game so player 1 and player 2 can play for all spots on board
            def play_flow():
                # player 1
                while True:
                    ...
                    if draw() == 'reset':
                        return 'reset'
                    if winning_by_row(player_picking[0]) or winning_by_col(player_picking[0]) or winning_by_diagonal(
                            player_picking[0]):
                    ...
                    if draw() == 'reset':
                        return 'reset'
                    if winning_by_row(player_picking[1]) or winning_by_col(player_picking[1]) or winning_by_diagonal(
                            player_picking[1]):
            ...
            def winning_by_row(sign):
                ...
                if board_of_game[0:3] == sign_for_winning or board_of_game[3:6] == sign_for_winning or board_of_game[
                    6::] == sign_for_winning:
                    return True
                else:
                    return False
            ...
            def winning_by_col(sign):
                sign_for_winning = [sign, sign, sign]
                if board_of_game[0::3] == sign_for_winning or board_of_game[1::3] == sign_for_winning or board_of_game[
                    2::3] == sign_for_winning:
                    return True
                else:
                    return False
